...
| `course-first.html` | 课程学习首次进入页（欢迎横幅、小机器人、普通话水平初测指引、AI伴学） |
| `course.html` | 课程学习页（课表日历、5大类课程标签、视频播放器、学习小贴士、图文心得、AI伴学） |
| `login.html` | 欢迎登录页（用户名、密码、记住密码、忘记密码跳转） |
| `forget-password.html` | 忘记密码/重置密码页（手机号验证、短信验证码倒计时、重置密码两步流转） |
| `my-courses.html` | 我的课程页（已选课程列表与学习进度展示） |
